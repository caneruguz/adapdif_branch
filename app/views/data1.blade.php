	            ...
	            <div class='row-fluid'>
					    <div class='span12 box bordered-box blue-border'>
					        ...
					        <div class='box-content box-double-padding'>
					            {{ Form::open(array('url' => 'upload', 'files' => true, 'class' => 'form')) }}
					                <fieldset>
					                    <div class='span4 box'>
					                        <div class='lead'>
					                    ...
					                    <div class='span7 offset1'>
										        ...
										        <div class='box-content'>
										            <div>
										                <input name="file" title='Search for a file to add' type='file'>
										            </div>
										        </div>
					             ...
					             <hr class='hr-normal'>
					                <fieldset>
					                    ...
					                    <div class='span7 offset1'>
					                        <div class='control-group'>
					                            ...
					                            <div class='controls'>
					                                <input  name="dataName" class='span12' id='data-name' type='text'>
						                ...
						                <div class='control-group'>
						                    ...
						                    <div class='controls'>
						                        <select name="dataType[]" id='inputSelectMulti' multiple='multiple'>
						                    ...
						                    <div class='controls'>
								                 <div>
								                    <div class='datepicker input-append' id='datepicker'>
								                        <input name="dataDate" class='input-medium' data-format='yyyy-MM-dd' placeholder='Select datepicker' type='text'>
											            <span class='add-on'>
						                 ...
						                 <div class='control-group'>
						                    <div class='controls'>
						                        <label class='checkbox'>
						                            <input name="firstRowHeader" type='checkbox' value='1'>
					                ...
					                <div class='form-actions' style='margin-bottom: 0;'>
					                    <div class='text-right'>
					                        <a href="{{URL::to('data2')}}" class="submit">
